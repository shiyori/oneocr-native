...
[GitHub Releases v0.1.0-rc.1](https://github.com/shiyori/oneocr-native/releases/tag/v0.1.0-rc.1) からダウンロードします。ソースのクローンは不要です。通常のインストールと認識では runtime パスを指定する必要はありません。
